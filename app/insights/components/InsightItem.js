...
const InsightItem = () => {
  return (
    <div>
      ...
      <div className='border-t py-10 flex flex-col gap-8 sm:flex-row'>
        ...
        <div className='w-[100%] sm:w-[60%] flex flex-col justify-between max-sm:mt-4'>
          ...
          <div className=''>
            <h3 className='text-3xl md:text-4xl sm:text-5xl font-bold'>AVY Pruthi, Nuneaton business owner – Coventry & Warwickshire Chamber workshops</h3>
          </div>
