...
const HowWeDo = () => {
  return (
    ...
    <div className='w-full sm:w-[25vw] flex flex-col gap-4 justify-center '> 
        ...
        <div className='border-2 p-16 sm:p-10 flex flex-col items-center justify-center gap-8 box-border max-sm:mt-2'>
            <img src="/assets/img/Research.svg" ></img>
            <Reveal>
            <h3 className='font-bold text-2xl xl:text-4xl 2xl:text-5xl text-black'>RESEARCH</h3>
            </Reveal>
        </div>
